...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multitasking-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12879&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multitasking-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multitasking` can be installed with:

```
conda install multitasking
```

It is possible to list all of the versions of `multitasking` available on your platform with:
